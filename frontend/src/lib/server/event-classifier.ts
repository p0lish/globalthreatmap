import type { EventCategory, ThreatLevel, ThreatEvent, GeoLocation } from "$lib/types";
...
export function extractKeywords(text: string): string[] {
	...
	const lowerText = text.toLowerCase();
	const found = allKeywords.filter((keyword) => lowerText.includes(keyword.toLowerCase()));
