...
export function ThreatMap() {
  ...
  return (
    ...
    >
      ...
      {selectedHospital && (
        ...
        >
          <div className="min-w-[240px] p-2">
            <div className="mb-2 flex items-center gap-2">
              <div
                className={`flex h-8 w-8 items-center justify-center rounded-full ${selectedHospital.status === "active"
                  ? "bg-red-500/20"
              ...
              >
                <svg
                  className={`h-4 w-4 ${selectedHospital.status === "active"
                    ? "text-red-400"
                    : selectedHospital.status === "contained"
                      ? "text-yellow-400"
                      : "text-blue-400"
              ...
              <div>
                ...
                <span
                  className={`text-xs ${selectedHospital.status === "active"
                    ? "text-red-400"
                    : selectedHospital.status === "contained"
                      ? "text-yellow-400"
                      : "text-blue-400"
      ...
      {selectedCountry && <CountryNewsModal
